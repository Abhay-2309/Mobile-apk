...
class BleScanner(private val bluetoothAdapter: BluetoothAdapter?) {
    ...
    private var onPacketDiscoveredListener: ((ByteArray, Int) -> Unit)? = null
    ...
    fun setOnPacketDiscoveredListener(listener: (ByteArray, Int) -> Unit) {
    ...
    fun startScanning(): Boolean {
        ...
        scanCallback = object : ScanCallback() {
            override fun onScanResult(callbackType: Int, result: ScanResult?) {
                ...
                if (manufacturerData != null && manufacturerData.size >= BlePacketCodec.PACKET_SIZE) {
                    val rssi = result.rssi
                    onPacketDiscoveredListener?.invoke(manufacturerData, rssi)
                }
            }
